      ...
      $sql = "select p.id, p.model, pro.naziv as pnaziv, p.zapremina, tip.naziv as tipnaziv, p.cena from parfem p join proizvodjac pro ON p.proizvodjac_id=pro.id join tip on p.tip_id=tip.id where p.model like '%" . $_POST['model_parfema'] . "%'";
